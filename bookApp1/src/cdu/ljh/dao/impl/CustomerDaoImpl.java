...
import cdu.ljh.dao.CustomerDao;
import cdu.ljh.model.Customer;
...
public class CustomerDaoImpl extends BaseDao implements CustomerDao {
    ...
    public List<Customer> query(Customer condition) {
        ...
        if (condition != null) {
            ...
            if (condition.getName() != null && !condition.getName().isEmpty()) {sql += " AND name LIKE '%" + condition.getName() + "%'";
            }
    ...
    public int count(Customer condition) {
        ...
        System.out.println("DAO查询count(con): " + sql);try {
